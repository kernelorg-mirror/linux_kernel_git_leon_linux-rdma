...
struct dma_buf_ops {
	 ...
	 * implement this. Called with the &dma_buf.resv reservation lock held,
	 * which is what lets an exporter refuse once it has revoked the buffer
	 * and started tearing the provider down. This callback is optional.
	 *
	 * Returns:
	 *
